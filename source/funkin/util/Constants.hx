...
class Constants
{
  ...
  /**
   * The color used if the healthbar color in the jason is not present.
   */
  public static final COLOR_HEALTH_BAR_GRAY:FlxColor = 0xFFA1A1A1;

  /**
   * The color used by the old icon.
   */
